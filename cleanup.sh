...
TAGS=("transformer" "transformers" "huggingface-upstream-proxy" "feature-extraction" "stable-diffusion" "sae" "classifier" "facebook" "causal-lm" "llm" "multilingual" "text-generation" "mms" "pytorch")
